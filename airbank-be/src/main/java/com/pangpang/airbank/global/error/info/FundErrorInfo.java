...
public enum FundErrorInfo {
	...
	SAVE_FUND_MANAGEMENT_PERMISSION_DENIED(HttpStatus.FORBIDDEN, 1203, "자금 관리를 저장할 권한이 없습니다."),
	ALREADY_EXISTS_FUND_MANAGEMENT(HttpStatus.CONFLICT, 1204, "자금 관리가 이미 존재합니다.");
